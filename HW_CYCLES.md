...
Один фрилансер, воспользовавшись гибкостью графика своего вида работы, решил смоделировать его по следующей схеме:
...
* Если он решает, что следующий месяц хочет отдохнуть, то за месяц его доходы уменьшаются на `expense`, а затем остаток доходов ещё уменьшается в три раза (траты на отдых);
