...
Запустите `mvn clean test`. Сборка должна упасть, тк плагин должен найти эту ошибку именования. Откройте полные логи сборки, кликнув на верхний пункт в левом нижнем окне, прокручивая их сверху вниз найдите первое упоминания слова `ERROR` (англ. Ошибка), убедитесь, что в этой строке идёт речь про неправильное именование переменной `Percent`:
